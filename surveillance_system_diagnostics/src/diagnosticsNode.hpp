...
namespace diagnostics {
    ...
    struct Components {
        ThreadSafeQueue<surveillance_system_msgs::diagnostic_event> diagnosticEventQueue;
        ThreadSafeQueue<surveillance_system_msgs::diagnostic_event> diagnosticSeverePriorityQueue;
...
class DiagnosticsNode {
    ...
    private:
        ...
        surveillance_system_msgs::diagnostic_event dataMsg;
        ...
        void diagnosticsReceiveHandler(const surveillance_system_msgs::diagnostic_eventConstPtr& data);
        void publishDiagnosticsData(const surveillance_system_msgs::diagnostic_event& diagnosticData);
