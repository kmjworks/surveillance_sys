...
void DiagnosticsNode::initROSIO() {
    ...
    rosInterface.pub_diagnosticData = nh.advertise<surveillance_system_msgs::diagnostic_event>("diagnostics/runtime_diagnostics", configuration.queueSize);
...
void DiagnosticsNode::diagnosticsReceiveHandler(const surveillance_system_msgs::diagnostic_eventConstPtr& data) {
    surveillance_system_msgs::diagnostic_event diagnosticMsg;
...
void DiagnosticsNode::severityProcessingLoop() {
    ...
    while(diagnosticsRunning && ros::ok()) {
        std::optional<surveillance_system_msgs::diagnostic_event> checkForSeverity = components.diagnosticSeverePriorityQueue.pop();
...
void DiagnosticsNode::publishDiagnosticsData(const surveillance_system_msgs::diagnostic_event& diagnosticData) {
    {
